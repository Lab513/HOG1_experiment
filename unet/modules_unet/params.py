def define_params(parser):
    ...
    parser.add_argument('-m', '--model', type=str, help='main model for segmentation')       # u-net model for main segmentation
    parser.add_argument('--model_events', type=str, help='model for various events')         # u-net model for events
    #parser.add_argument('--model_anaph', type=str, help='model for anaphase detection')      # u-net model for anaphase
    parser.add_argument('-l', '--lineage', action='store_true', default=False)              # processing with video
    ...
    parser.add_argument('-r', '--rfp', type=str, help='RFP film')                   # RFP
    ...
    parser.add_argument('--kind_track', type=str, help='min or hungarian or None')
    ...
    parser.add_argument('--nb_imgs_proc', type=int, help='number of images processed', default=-1)    # FillFlood or directly from predictions
